...
export default function MonthGrid({ year, monthIndex, postsByDate = new Map(), ideasByDate = new Map(), onSelectDate }) {
        ...
        {cells.map((day, idx) => {
          ...
          return (
            <button
              ...
              title={idea ? `${idea.type.toUpperCase()} · ${idea.pillar} — ${idea.title}` : undefined}
            >
